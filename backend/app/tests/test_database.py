...
class TestMongoDBRecipeCollection(unittest.TestCase):
    ...
    def test_search_recipe(self):
        ...
        self.recipe_collection.food_collection.insert_one({"id": str(uuid.uuid4()), "created_on": formatted_now,  **self.sample_recipe})
    ...
    def test_get_recipe_by_id(self):
        ...
        self.recipe_collection.food_collection.insert_one({"id": recipe_id, **self.sample_recipe})
    ...
    def test_get_recipes(self):
        ...
        self.recipe_collection.users_collection.insert_one({"id": user_id, "recipes": [recipe_id]})
        self.recipe_collection.food_collection.insert_one({"id": recipe_id, "created_on": formatted_now, **self.sample_recipe})
