...
export default function Header(){
    return (
        <div className="w-full flex my-3 place-items-center">
            <img className="h-7 w-10 m-1" src={logo} alt="chef-hat" />
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" className='absolute right-5 m-1 w-6 h-6 stroke-logo-red'>
